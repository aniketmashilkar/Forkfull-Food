...
?>
    <head>
        <title>Admin Update Recipes</title> 
    ...
    error_reporting(E_ALL^E_NOTICE);
        ...
        $query = "SELECT * FROM adrecp where id = '$id'";
        echo $query;
        $res = $db->query($query);
        ...
        <div id="div_main" > 
		 <div id="head"></div>
			...
			<div id="mainbody">
                ...
                <h1 style="font-size:50px;border-bottom: 1px dotted;color: #99CC00;" align="center">UPDATE YOUR RECIPIES</h1>
                <form method="post" action="" enctype="multipart/form-data" >
                <table cellspacing="5" cellpadding="10">
                <tr><td><b>TITLE</b></td><td>:</td><td><input class="input" type="text" name="title" id="title"  value = "<?php echo $title;?>" required placeholder='Title'></td></tr>
                <tr><td><b>INGREDIENTS</b></td><td>:</td><td><textarea  id="ingred" name="ingred" class="textarea" rows="8" cols="50"  required><?php echo $ing;?></textarea></td></tr>
                <tr><td><b>METHOD</b></td><td>:</td><td><textarea id="method" name="method" class="textarea" rows="8" cols="50" required><?php echo $method;?></textarea></td></tr>
                <tr><td><b>TYPE</b></td><td>:</td><td><input type="radio" name="types" value="veg" <?php if ($type == 'veg') echo 'checked="checked"'; ?>"><b>VEG.</b>
                    <input type="radio" name="types" value="non-veg" <?php if ($type == 'non-veg') echo 'checked="checked"'; ?>"><b>NON-VEG.</b></td></tr>
                <tr><td><b>COOKTIME</b></td><td>:</td><td><input  class="input" name="ctime" type="text" id="ctime" value = "<?php echo $cooktime;?>" required></td></tr>
            ...
            $query = "UPDATE `adrecp` SET `TITLE`='$title',`INGREDIENTS`='$ingred',`METHOD`='$method',`TYPE`='$type',`COOKTIME`='$ctime',`upload`='$date' WHERE id='$id'";
