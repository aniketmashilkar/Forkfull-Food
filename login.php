   ...
   ?>
        ...
        <div id="div_main" > 
		 <div id="head"></div>
			...
			<div align="center" >
					<div id="logtemp">
					<h1 style="font-size:50px;border-bottom: 1px dotted;color: black;" align="center">USER LOGIN</h1>
					...
					<table cellspacing="2" cellpadding="2" >
						...
						<tr><td colspan="2"><input type="submit" value="LOGIN"  name="submit" /></td><td><a href="regform.php"><button type="button">REGISTER</button></a></tr>
					</table>
					</form>
					</div>
				</div>
